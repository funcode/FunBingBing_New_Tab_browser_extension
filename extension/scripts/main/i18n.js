...
function i18n_widgets_toggle_button() {
    var widgetsToggle = document.getElementById('widgets-toggle');
    if (widgetsToggle) widgetsToggle.title = i18n('toggle_clock_title');
}
